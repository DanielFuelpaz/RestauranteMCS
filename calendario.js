...
botonReserva4.addEventListener('click',function(){
      ...
      if (response.ok) {
        ...
        if (response2.ok) {
          ...
          if (response3.ok) {
            ...
            // Aquí puedes colocar el código que depende de cedulaCliente e IDRestaurante
            const nuevaReserva = {
              FEC_HOR_RES: new Date(),
  ...
  //Ver que el cliente que se ingrese no existe, caso contrario poner la reserva a ese mismo cliente
  //ya existente.
